...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Insurance ALgo8 - Industry Solutions | Insurance ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Industry Solutions | Insurance</title>
	<style>
...
<body>
    ...
    <!-- Start: .hero-area -->
    <section class="intro insurance">
        <div class="container">
            <div class="intro-details">
                <div class="intro-info">
                     <?php
							while($row = mysql_fetch_array($ins1)){
            ...
            <div class="row">
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            <h2>
                                How Algo8 has helped Insurance Companies
                            </h2>
                            <p>Algo 8 platform and frameworks for insurance services enable them in </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <ul uk-accordion>
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Localised pricing
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Weather Risk Prediction
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Subrogation Recovery Analysis
                                    </li>
                                    <li>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Loc8 for Insurance Companies</a>
                            <div class="uk-accordion-content">
                                <p>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Opini8 for Insurance Companies</a>
                            <div class="uk-accordion-content">
                                <p>
    ...
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Insurers as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project-single">
                                            <?php
							while($row = mysql_fetch_array($ins2)){
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
                                           <?php
							while($row = mysql_fetch_array($ins3)){
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Insurance company today </h2>
