...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Banking ALgo8 - Industry Solutions | Banking ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Industry Solutions | Banking</title>
	<style>
    ...
    <section class="intro banking">
        <div class="container">
            <div class="intro-details">
				...
				<?php
							while($row = mysql_fetch_array($bank1)){
            ...
            <div class="row">
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            <h2>
                                How Algo8 has helped Banks
                            </h2>
                            <p>Algo8 platform and frameworks for banks and financial services enable them in </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <ul uk-accordion>
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Predictive Fraud Detection and Monitoring
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Face recognition
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Predictive Risk Management
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Predictive Credit Underwriting
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> OCR Automation
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> AI Powered customer targeting and Cross sell
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Predictive Infrastructure Maintenance and Incidence Management
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <a class="uk-accordion-title" href="#">Loc8 for Banks</a>
                            <div class="uk-accordion-content">
                                <p>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Opini8 for Banks</a>
                            <div class="uk-accordion-content">
                                <p>
                    ...
                    <a href="bfsi.php" style="font-weight:500; font-size:20px;">VIEW CASE STUDY</a>
        ...
        <div class="full-width-testimonial-section">
            ...
            <div class="full-width-testimonial-content">
                <h5 class="full-width-testimonial-text">
                    The distributed system created by Algo8 has helped us reduce our MIS generation and production time. Also, it has increased the potential value we can extract from data from different sources in a way more flexible and scalable way.
                </h5>
                <p class="full-width-testimonial-source">Anmol Nayyar</p>
                <span class="full-width-testimonial-source-context">DMI FINANCE</span>
            </div>
        </div>
    </div>
    <!-- Start publications -->
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Banks as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
									...
									<?php
							while($row = mysql_fetch_array($bank2)){

					        ?>
                                        <figure>
										
                                            <img src="<?php echo 'admin/site-images/'.$row['image']?>" alt="banner" class="img-fluid">
                                            <figcaption>
                                                <h3>
                                                   <?php echo $row['imagetext2'] ?>
                                                </h3>
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
									<?php
							while($row = mysql_fetch_array($bank3)){

					        ?>
                                        <figure>
										
                                            <img src="<?php echo 'admin/site-images/'.$row['image']?>" alt="expert" class="img-fluid">
                                            <figcaption>
                                                <h3><?php echo $row['imagetext2'] ?> </h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Bank today </h2>
