...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Government ALgo8 - Industry Solutions | Government ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Industry Solutions | Government</title>
	<style>
...
<body>
    ...
    <!-- Start: .hero-area -->
    <section class="intro government">
        <div class="container clearfix">
            <div class="intro-details">
                <div class="intro-info">
                     <?php
							while($row = mysql_fetch_array($govt1)){
            ...
            <div class="row">
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            <h2>
                                How Algo8 has helped Government
                            </h2>
                            <p>Algo 8 platform and frameworks for Governance enable them in</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <ul uk-accordion>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">People Lifecycle Managment Analytics</a>
                            <div class="uk-accordion-content">
                                <p>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Loc8 for Government</a>
                            <div class="uk-accordion-content">
                                <p>
                ...
                <div class="col-md-6">
                    <iframe height="315" width="100%" src="https://www.youtube.com/embed/7_Rpdnl1VwQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="full-width-testimonial-section">
            ...
            <div class="full-width-testimonial-content">
                <h5 class="full-width-testimonial-text">
                    The team at Algo8 has helped us deliver impactful use cases for our clients in retail and government domains.
    ...
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Government as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project-single">
                                        <?php
							while($row = mysql_fetch_array($govt2)){
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
                                         <?php
							while($row = mysql_fetch_array($govt3)){
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Government today </h2>
