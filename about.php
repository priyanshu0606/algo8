...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Who we are | About Algo8 ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Who we are | About Algo8</title>
    <!-- inject:css -->
...
<body>
    ...
    <!-- Ends: header -->
    <section class="hero-area" id="particles">
        <div class="hero-area-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 style="color:#333;">
                            <q style="font-size:60px"><span>Genius</span> is to <span>create</span> what is needed </q>
                        </h1>
                        <p>
                            We create potent data driven tech which is decisive in driving our client's growth.
                        </p>
                    </div>
                </div>
            </div>
        </div>
        <!-- Ends: .hearo-area-content -->
    </section>
                ...
                <div class="col-md-12">
                    <div class="flow-process">
                        <div class="row">
					     ...
					     ?>
                                        <h3 class="scolor"><?php echo $row['category2'] ?></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    ...
                                    <div class="desc">
									<?php
							while($row = mysql_fetch_array($w1)){
					     ...
					     ?>
                            ...
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    <div class="desc">
                                        ...
                                        <p>Landmark Case Study published by Harvard Business Review</p>
                                    </div>
                            ...
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    ...
                                    <div class="desc">
									<?php
							while($row = mysql_fetch_array($w3)){
					     ...
					     ?>
                            ...
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    <div class="desc">
									<?php
							while($row = mysql_fetch_array($w4)){
					     ...
					     ?>
                            ...
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    ...
                                    <div class="desc">
									<?php
							while($row = mysql_fetch_array($w5)){
					     ...
					     ?>
                            ...
                            <div class="col-lg-2 col-sm-6 flow-wrapper">
                                <div class="flow-single">
                                    <div class="desc">
									<?php
							while($row = mysql_fetch_array($w6)){
