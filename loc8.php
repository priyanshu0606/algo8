...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Platform Loc8 - Industry Solutions | Platform Loc8 ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Platform | Loc8</title>
	<style>
...
<body>
    ...
    <!-- Start: .hero-area -->
    <section class="intro loc8">
        <div class="container">
            <div class="intro-details">
                <div class="intro-info">
				<?php
							while($row = mysql_fetch_array($loco1)){
    ...
    <section class="services">
        <div class="container">
            <div class="row">
			<?php
							while($row = mysql_fetch_array($loco2)){
                ...
                <div class="col-lg-6 col-md-12 service-image">
                    <figure>
                        <img src="<?php echo 'admin/site-images/'.$row['image']?>" alt="Loc8 Banner" class="img-fluid">
                    </figure>
                </div>
    ...
    <section class="about-contents">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p>The convenience of online can only be answered by the personalized experience of hyper local.Any outlet dealing with retail customers, be it a grocery store, bank or an F&B outlet will have to be planned according to the customers it is supposed to cater to.But, 90% of the data about the customer lies outside your databases.To resolve this, Loc8 has been designed to do the following:</p>
                    <ul>
                        <li>
                    ...
                    <a href="loc8-case-study.php" style="font-weight:500; font-size:20px;">VIEW CASE STUDY</a>
                </div>
    ...
    <div class="col-md-12 research-keynotes">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6">
                <div class="box">
				<?php
							while($row = mysql_fetch_array($feature1)){
            ...
            <div class="col-lg-2 col-md-6">
                <div class="box">
                    <span class="icon-map"></span>
					<?php
							while($row = mysql_fetch_array($feature2)){
            ...
            <div class="col-lg-2 col-md-6">
                <div class="box">
					...
					<?php
							while($row = mysql_fetch_array($feature3)){
            ...
            <div class="col-lg-2 col-md-6">
                <div class="box">
					...
					<?php
							while($row = mysql_fetch_array($feature4)){
            ...
            <div class="col-lg-2 col-md-6">
                <div class="box">
					...
					<?php
							while($row = mysql_fetch_array($feature5)){
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
									...
									<?php
							while($row = mysql_fetch_array($expert1)){

					        ?>
                                        <figure>
                                            <img src="<?php echo 'admin/site-images/'.$row['image']?>" alt="Loc8 Overview" class="img-fluid">
                                            <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
									<?php
							while($row = mysql_fetch_array($expert2)){
