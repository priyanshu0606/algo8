...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Manufacturing ALgo8 - Industry Solutions | Manufacturing ">
...
<body>
    ...
    <!-- Start: .hero-area -->
    <section class="intro manufacturing">
        <div class="container">
            <div class="intro-details">
                <div class="intro-info">
                     <?php
							while($row = mysql_fetch_array($manu1)){
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            ...
                            <p>Algo 8 platform and frameworks for manufacturing services</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <ul uk-accordion>
                        <li>
                            <a class="uk-accordion-title" href="#">Data Science for leaders </a>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Ad8</a>
                            <div class="uk-accordion-content">
                                <p>Advise and help create AI roadmap for the Organization. The roadmap included creation of a data science COE , helping organization in hiring the right talent ,formulation of a data governance office</p>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                <p> CustomizedAI and Pattern based Learning Solutioning for contextual application in enterprises. Creation, Conception and Development of use cases in highly secure environments for</p>
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Process Analytics use case like anomaly detection in final product quality
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Prediction of lab test result at run time
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Predictive maintenance for generators , and other complex process machines
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> NLP powered Project Management recommendation system
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> AI Powered demand and supply forecast of finished product as well as raw materia
                                    </li>
                                </ul>
                            </div>
                        </li>
    ...
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Manufacturers as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project-single">
                                        <?php
							while($row = mysql_fetch_array($manu2)){
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
                                        <?php
							while($row = mysql_fetch_array($manu3)){
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Manufacturer today </h2>
