...
footer .footer-right ul.social-icons2 li a i.fa.fa-google-plus:hover { 
    ...
    <meta name="description" content=" Loc8-Case Studies ALgo8 - Platform| Loc8 ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Loc8-Case Studies | Platform</title>
    <!-- inject:css -->
                ...
                <div class="col-lg-8 offset-lg-2 col-md-12">
                    <div class="blog-details">
                        <div class="blog-contents noselect">
                            ...
                            <p>
                                Algo8’s location intelligence tool , Loc8 , was used to achieve these milestones. Though it was a daunting task, in the end it did yield astounding results.
                            </p>
                            <h2 class="blog-title">
                            ...
                            <blockquote>
                                <span class="icon-speech"></span> “The team has expertise in machine learning  algorithms and pattern based analytics.”- Sandipan Chattopadhay , Ex- CTO, Justdial
                            </blockquote>
                            <p>
                            ...
                            <p>For Predictive Inventory Analysis , Algo8 collected the relevant data of each product. Advance forecasting techniques were applied on this data to forecast the demand and supply. The output was then fed to Predictive Analytics Algorithms which recommended the right amount of goods to be procured .</p>
                            <p>
