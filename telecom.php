...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content="Telcom ALgo8 - Industry Solutions | Telecom ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Industry Solutions | Telecom</title>
	<style>
        ...
        <div class="container">
            <div class="intro-details">
                <div class="intro-info">
                     <?php
							while($row = mysql_fetch_array($tele1)){
                ...
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            ...
                            <p>Algo 8 platform and frameworks for Telecom services enable them in </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <ul uk-accordion>
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                <p>Creating a 360 degree view of the customer, their profiling, creating a customer story and enabling analytics driven intervention</p>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                <p>CustomizedAI and Pattern based Learning Solutioning for contextual application in enterprises. Creation, Conception and Development of use cases in highly secure environmentsfor</p>
                                <h3>
                                    Customers
                                </h3>
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Subscriber churn prediction
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Customer Targeting as a Service (CTaaS)

                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Customer Experience Index
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Browsing Behavior based Subscriber Segmentation
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Customer Data Adaptation analysis
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Enhanced Customer Support Using NLP
                                    </li>
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Fault Prediction and Predictive maintainence
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Congestion Detection
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Demand Forecasting
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Content Classification
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Service Assurance
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <a class="uk-accordion-title" href="#">Opini8 for Telecom</a>
                            <div class="uk-accordion-content">
                                <p>
                    ...
                    <a href="telecom-case-study.php" style="font-weight:500; font-size:20px;">VIEW CASE STUDY</a>
                </div>
                <div class="col-md-6">
        ...
        <div class="full-width-testimonial-section">
            ...
            <div class="full-width-testimonial-content">
                <h5 class="full-width-testimonial-text">
                    Algo8.ai advised us on our journey of advanced analytics and drill value out of the the new 'oil' which is data.  It  effected into new business streams like the F&B customer loyalty and retention analytics and the Marketing Cloud Innovation we created
                </h5>
                <p class="full-width-testimonial-source">Vikarm Raichura</p>
                <span class="full-width-testimonial-source-context">MD, Vivaconnect</span>
            </div>
        </div>
    </div>
    <!-- Start publications -->
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Telecom as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project-single">
                                          <?php
							while($row = mysql_fetch_array($tele2)){
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
                                        <?php
							while($row = mysql_fetch_array($tele3)){
                                        ...
                                        <figure>
                                            ...
                                            <figcaption>
                                                ...
                                                <a onclick="myFunction()" id="myBtn">
                                                    <span class="icon-arrow-left"></span>Read More
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Telecom today </h2>
