...
<!--End of Tawk.to Script-->
    ...
    <meta name="description" content=" Healthcare ALgo8 - Industry Solutions | Healthcare ">
    <meta name="keywords" content="Algo8, ai, artificial intelligence, machine learning">
    <title>Industry Solutions | Healthcare</title>
	<style>
...
<body>
    ...
    <!-- Start: .hero-area -->
    <section class="intro healthcare">
        <div class="container">
            <div class="intro-details">
                <div class="intro-info">
                     <?php
							while($row = mysql_fetch_array($health1)){
            ...
            <div class="row">
                <div class="col-md-12 wcu research-features">
                    <div class="row">
                        <div class="col-md-12 section-title">
                            <h2>
                                How Algo8 has helped Healthcare
                            </h2>
                            <p>Algo 8 platform and frameworks for Pharma and healthcare services enable them in </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                        ...
                        <li>
                            ...
                            <div class="uk-accordion-content">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Market Mix Modelling
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Spend Optimisation
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Drug Response Analysis
                                    </li>
                                    <li>
                                        <span class="icon-arrow-right-circle"></span> Drug Effectiveness Assessment
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <ul uk-accordion>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Loc8 for Healthcare</a>
                            <div class="uk-accordion-content">
                                <p>
                        ...
                        <li>
                            <a class="uk-accordion-title" href="#">Opini8 for Healthcare</a>
                            <div class="uk-accordion-content">
                                <p>
                                    An NLP based brand perception tool, which collates all social chatter about a pharma company and its competitors from channels like mail, social media,news,etc. Opini8 also enables customer support through NLP.
                                </p>
                            </div>
        ...
        <div class="full-width-testimonial-section">
            ...
            <div class="full-width-testimonial-content">
                <h5 class="full-width-testimonial-text">
                    The drug response analysis was done with accuracy by algo8<br />
                </h5>
                <p class="full-width-testimonial-source">- A leading Pharma company</p>
            </div>
        </div>
    </div>
    <!-- Start publications -->
    <section class="publications section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-title">
                    <h2>
                        How AI can help Heathcare as per expert
                    </h2>
                </div>
                <!-- Ends: .section-title -->
                <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="project-single">
                                         <?php
							while($row = mysql_fetch_array($health2)){
							...
							?>
                                ...
                                <div class="col-md-6">
                                    <div class="project-single">
                                        <?php
							while($row = mysql_fetch_array($health3)){
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 cta-contents">
                    <h2>Become an AI driven Healthcare today </h2>
